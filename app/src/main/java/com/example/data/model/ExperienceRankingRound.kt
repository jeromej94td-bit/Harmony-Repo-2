...
/**
 * Bridges stable experience item IDs to the shipped ranking-v1 answer format, whose payload keeps
 * visible labels. This preserves existing stored answers while experience runners work with IDs.
 */
...
/** Proposal compatibility adapter; content remains proposal-owned. */
