...
object TotImageProvider {
    ...
    private val directMap: Map<String, Any> = mapOf(
        ...
        "Cappuccino" to R.drawable.tot_drink_cappuccino,
        "Matcha-Latte" to R.drawable.tot_drink_matcha_latte,
        "Heiße Schokolade" to R.drawable.tot_drink_hot_chocolate,
        "Eistee" to R.drawable.tot_drink_iced_tea,
        "Minzlimonade" to R.drawable.tot_drink_mint_lemonade,
        "Fruchtpunsch" to R.drawable.tot_drink_fruit_punch,
        "Bier" to R.drawable.tot_drink_beer,
        "Rote-Bete-Saft" to R.drawable.tot_drink_beetroot_juice,
        "Coca-Cola" to R.drawable.tot_drink_cola,
        "Cola" to R.drawable.tot_drink_cola,
        "Fanta" to R.drawable.tot_drink_orange_soda,
        "Orangenlimonade" to R.drawable.tot_drink_orange_soda,
        "Orangensaft" to R.drawable.tot_drink_orange_juice,
        "Apfelsaft" to R.drawable.tot_drink_apple_juice,
        "Kaffee" to R.drawable.tot_drink_coffee,
        "Tee" to R.drawable.tot_drink_tea,
        "Hund" to R.drawable.animal_hund,
        "Katze" to R.drawable.animal_katze,
        "Singvogel" to R.drawable.animal_singvogel,
        "Pinguin" to R.drawable.animal_pinguin,
        "Kaninchen" to R.drawable.animal_kaninchen,
        "Otter" to R.drawable.animal_otter,
        "Roter Panda" to R.drawable.animal_roter_panda,
        "Fuchs" to R.drawable.animal_fuchs,
        "Meerschweinchen" to R.drawable.animal_meerschweinchen,
        "Giraffe" to R.drawable.animal_giraffe,
        "Löwe" to R.drawable.animal_loewe,
        "Gorilla" to R.drawable.animal_gorilla,
        "Meeresschildkröte" to R.drawable.animal_meeresschildkroete,
        "Igel" to R.drawable.animal_igel,
        "Tiger" to R.drawable.animal_tiger,
        "Wolf" to R.drawable.animal_wolf,
        "Adler" to R.drawable.animal_adler,
        "Delfin" to R.drawable.animal_delfin,
        "Töpfern" to R.drawable.tot_hobby_pottery,
        "Klavier spielen" to R.drawable.tot_hobby_piano,
        "Malen" to R.drawable.tot_hobby_painting,
        "Zeichnen" to R.drawable.tot_hobby_drawing,
        "Badminton" to R.drawable.tot_hobby_badminton,
        "Mountainbike" to R.drawable.tot_hobby_mountainbike,
        "Bowling" to R.drawable.tot_hobby_bowling,
        "Holzwerken" to R.drawable.tot_hobby_woodworking,
        "Gitarre spielen" to R.drawable.tot_hobby_guitar,
        "Tennis" to R.drawable.tot_hobby_tennis,
        "Brettspiele" to R.drawable.tot_hobby_board_games,
        "Darts" to R.drawable.tot_hobby_darts,
        ...
        // ★ Aktivitäten & Essen
        "Wandern" to R.drawable.tot_hobby_hiking,
