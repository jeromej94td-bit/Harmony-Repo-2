    ...
    Box(
        ...
        Column(
            ...
            IconButton(
                ...
                modifier = Modifier.size(54.dp).background(Color.Black.copy(alpha = 0.62f), CircleShape)
            ) {
            ...
            if (!errorMessage.isNullOrBlank()) {
                Text(text = errorMessage, color = Color(0xFFFF8CA8), fontSize = 13.sp, modifier = Modifier.padding(bottom = 14.dp))
            }
            ...
            Row(
                ...
                Text(
                    text = if (isReset) "Ich stimme zu, Harmony zurückzusetzen" else "Ich stimme zu, mein Konto zu löschen",
                    color = HarmonyPink,
                    fontSize = 16.sp,
...
private fun LifecycleBullet(text: String) {
    Row(
        ...
        Box(
            modifier = Modifier.padding(top = 2.dp).size(34.dp).background(HarmonyPink, CircleShape),
