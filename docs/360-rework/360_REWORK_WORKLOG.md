...
Run the focused build in a Gradle-capable environment. If it succeeds, record the result, mark 02.1 complete, open/merge the small package PR, and advance to 24.3.
